...
def get_version_xml(version):
	scheme_fold = os.path.normcase("E:\client\CandyCarrier\Client\\" + ppath.client_root +"\Build\FileScheme")
...
output_path = os.path.normcase("E:\client\CandyCarrier\Client\\"+ ppath.client_root +"\Output")
build_path = os.path.normcase("E:\client\CandyCarrier\Client\\"+ ppath.client_root +"\Build")
...
if not same_version:
	...
	print "client root:" + ppath.client_root
	...
	#------DataEncryption start------
	#comment this file if you want a non-encrypted make
	...
	apk_file = r"E:/client/CandyCarrier/Client/"+ ppath.client_root +"/PolarClient/proj.android/bin/PolarClient-release.apk"
	#bbxhz_1.1.0.12_patch.xml
	...
	os.chdir("E:/client/CandyCarrier/Client/"+ ppath.client_root +"/Build")
	for file in send_files: 
		if not os.path.exists(file):
			raise Exception(file + "not exist")
		cmd = r'C:\cygwin64\bin\bash.exe --login "E:\client\CandyCarrier\Client\{0}\Build\BUILD.sh" {1} {2} {3} {4} {5} {6}'.format(ppath.client_root,strs[0],strs[1],strs[2],strs[3],strs[4],file)
		print "cmd : " + cmd 
